 ...
 */
  ...
  /*-------- Stockage du resultat des frais kilometriques dans une variable  */
  $requete2 = obtenirTotalFraisKM(obtenirIdUserConnecte(), $moisSaisi);
  $queryFraisKm = mysql_query($requete2, $idConnexion);
  $fraisKm = mysql_result($queryFraisKm, 0);
...
<?php          
  	...
  	<table class="listeLegere">
        ...
        <tr>
            ...
            ?>
                <!-- Ajout du resultat des frais Km -->
                <td class="qteForfait"><?php echo $fraisKm; ?></td>
        </tr>
    </table>
  	<table class="listeLegere">
